...
var productList = `  <li class="products-list-item">
                <img src="%photo%" alt="card-1" class="products-img">
                <div class="overlay">
                    <button class="add-to-card" id="%id%" onclick="addCart(this.id)"><svg class="cart-svg" viewBox="0 0 32 29"
...
var cartList = ` <div class="cart-shopping-item" id="%id%">
                <img src="%photo%" alt="cart-shopping-card-1" class="cart-shopping-img">
                <div class="cart-shopping-text">
                    <button class="cart-shopping-button-close"></button>
                    <h3 class="cart-shopping-item-title">%title%</h3>
                    <p class="cart-shopping-item-span">Price: <span
                            class="cart-shopping-item-price">$%price%</span><br>
                        Color: %color%<br>
                        Size: %size%<br></p>
                    <label class="cart-shopping-item-span">Quantity:<input class="cart-shopping-item-quantity"
                            type="number" max="10" min="1" value="%quantity%" onchange="onQuantity(value)"></label>
                </div>
            </div>`.trim();
